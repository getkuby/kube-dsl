...
module KubeDSL
  module ValueFields
    ...
    sig { params(field: Symbol, default: T.any).void }
    def self.value_field(field, default: nil); end

    sig { params(field: Symbol, field_block: T.proc.void).void }
    def object_field(field, &field_block); end

    sig { params(field: Symbol, format: Symbol).void }
    def key_value_field(field, format:); end

    sig { params(field: Symbol, accessor: T.nilable(Symbol), field_block: T.proc.void).void }
