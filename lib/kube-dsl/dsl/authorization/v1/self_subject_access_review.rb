module KubeDSL::DSL::Authorization::V1
  class SelfSubjectAccessReview < ::KubeDSL::DSLObject
    ...
    object_field(:spec) { KubeDSL::DSL::Authorization::V1::SelfSubjectAccessReviewSpec.new }
    object_field(:status) { KubeDSL::DSL::Authorization::V1::SubjectAccessReviewStatus.new }

    validates :metadata, object: { kind_of: KubeDSL::DSL::Meta::V1::ObjectMeta }
    validates :spec, object: { kind_of: KubeDSL::DSL::Authorization::V1::SelfSubjectAccessReviewSpec }
