module KubeDSL::DSL::Storage::V1beta1
  class VolumeAttachment < ::KubeDSL::DSLObject
    ...
    validates :spec, object: { kind_of: KubeDSL::DSL::Storage::V1beta1::VolumeAttachmentSpec }
    validates :status, object: { kind_of: KubeDSL::DSL::Storage::V1beta1::VolumeAttachmentStatus }
