...
module KubeDSL::DSL::Storage::V1alpha1
  class VolumeAttachmentStatus < ::KubeDSL::DSLObject
    ...
    validates :attach_error, object: { kind_of: KubeDSL::DSL::Storage::V1alpha1::VolumeError }
    ...
    validates :detach_error, object: { kind_of: KubeDSL::DSL::Storage::V1alpha1::VolumeError }
