    ...
    module Discovery
      module V1beta1
        class EndpointSlice < ::KubeDSL::DSLObject
          ...
          validates :endpoints, array: { kind_of: KubeDSL::DSL::Discovery::V1beta1::Endpoint }, presence: false
          validates :metadata, object: { kind_of: KubeDSL::DSL::Meta::V1::ObjectMeta }
          validates :ports, array: { kind_of: KubeDSL::DSL::Discovery::V1beta1::EndpointPort }, presence: false
