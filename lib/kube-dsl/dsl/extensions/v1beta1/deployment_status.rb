module KubeDSL::DSL::Extensions::V1beta1
  class DeploymentStatus < ::KubeDSL::DSLObject
    ...
    array_field(:condition) { KubeDSL::DSL::Extensions::V1beta1::DeploymentCondition.new }
    ...
    validates :conditions, array: { kind_of: KubeDSL::DSL::Extensions::V1beta1::DeploymentCondition }, presence: false
