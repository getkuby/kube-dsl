...
module KubeDSL::DSL::Extensions::V1beta1
  class ReplicaSetStatus < ::KubeDSL::DSLObject
    ...
    array_field(:condition) { KubeDSL::DSL::Extensions::V1beta1::ReplicaSetCondition.new }
    ...
    validates :conditions, array: { kind_of: KubeDSL::DSL::Extensions::V1beta1::ReplicaSetCondition }, presence: false
