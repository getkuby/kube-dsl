module KubeDSL::DSL::Extensions::V1beta1
  class PodSecurityPolicySpec < ::KubeDSL::DSLObject
    ...
    array_field(:allowed_csi_driver) { KubeDSL::DSL::Extensions::V1beta1::AllowedCSIDriver.new }
    value_field :allowed_capabilities
    array_field(:allowed_flex_volume) { KubeDSL::DSL::Extensions::V1beta1::AllowedFlexVolume.new }
    array_field(:allowed_host_path) { KubeDSL::DSL::Extensions::V1beta1::AllowedHostPath.new }
    ...
    object_field(:fs_group) { KubeDSL::DSL::Extensions::V1beta1::FSGroupStrategyOptions.new }
    value_field :host_ipc
    value_field :host_network
    value_field :host_pid
    array_field(:host_port) { KubeDSL::DSL::Extensions::V1beta1::HostPortRange.new }
    value_field :privileged
    value_field :read_only_root_filesystem
    value_field :required_drop_capabilities
    object_field(:run_as_group) { KubeDSL::DSL::Extensions::V1beta1::RunAsGroupStrategyOptions.new }
    object_field(:run_as_user) { KubeDSL::DSL::Extensions::V1beta1::RunAsUserStrategyOptions.new }
    object_field(:runtime_class) { KubeDSL::DSL::Extensions::V1beta1::RuntimeClassStrategyOptions.new }
    object_field(:se_linux) { KubeDSL::DSL::Extensions::V1beta1::SELinuxStrategyOptions.new }
    object_field(:supplemental_groups) { KubeDSL::DSL::Extensions::V1beta1::SupplementalGroupsStrategyOptions.new }
    value_field :volumes

    validates :allow_privilege_escalation, field: { format: :boolean }, presence: false
    validates :allowed_csi_drivers, array: { kind_of: KubeDSL::DSL::Extensions::V1beta1::AllowedCSIDriver }, presence: false
    validates :allowed_capabilities, field: { format: :string }, presence: false
    validates :allowed_flex_volumes, array: { kind_of: KubeDSL::DSL::Extensions::V1beta1::AllowedFlexVolume }, presence: false
    validates :allowed_host_paths, array: { kind_of: KubeDSL::DSL::Extensions::V1beta1::AllowedHostPath }, presence: false
    ...
    validates :fs_group, object: { kind_of: KubeDSL::DSL::Extensions::V1beta1::FSGroupStrategyOptions }
    ...
    validates :host_ports, array: { kind_of: KubeDSL::DSL::Extensions::V1beta1::HostPortRange }, presence: false
    ...
    validates :run_as_group, object: { kind_of: KubeDSL::DSL::Extensions::V1beta1::RunAsGroupStrategyOptions }
    validates :run_as_user, object: { kind_of: KubeDSL::DSL::Extensions::V1beta1::RunAsUserStrategyOptions }
    validates :runtime_class, object: { kind_of: KubeDSL::DSL::Extensions::V1beta1::RuntimeClassStrategyOptions }
    validates :se_linux, object: { kind_of: KubeDSL::DSL::Extensions::V1beta1::SELinuxStrategyOptions }
    validates :supplemental_groups, object: { kind_of: KubeDSL::DSL::Extensions::V1beta1::SupplementalGroupsStrategyOptions }
