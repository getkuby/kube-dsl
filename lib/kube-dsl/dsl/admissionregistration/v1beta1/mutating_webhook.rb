module KubeDSL::DSL::Admissionregistration::V1beta1
  class MutatingWebhook < ::KubeDSL::DSLObject
    ...
    value_field :reinvocation_policy
    ...
    validates :client_config, object: { kind_of: KubeDSL::DSL::Admissionregistration::V1beta1::WebhookClientConfig }
    ...
    validates :reinvocation_policy, field: { format: :string }, presence: false
    validates :rules, array: { kind_of: KubeDSL::DSL::Admissionregistration::V1beta1::RuleWithOperations }, presence: false
