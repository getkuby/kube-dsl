...
module KubeDSL::DSL::Apiextensions::V1
  class CustomResourceDefinition < ::KubeDSL::DSLObject
    ...
    validates :spec, object: { kind_of: KubeDSL::DSL::Apiextensions::V1::CustomResourceDefinitionSpec }
    validates :status, object: { kind_of: KubeDSL::DSL::Apiextensions::V1::CustomResourceDefinitionStatus }
