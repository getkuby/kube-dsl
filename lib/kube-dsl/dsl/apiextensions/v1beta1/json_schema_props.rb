...
module KubeDSL::DSL::Apiextensions::V1beta1
  class JSONSchemaProps < ::KubeDSL::DSLObject
    ...
    object_field(:not_field) { KubeDSL::DSL::Apiextensions::V1beta1::JSONSchemaProps.new }
    ...
    validates :all_ofs, array: { kind_of: KubeDSL::DSL::Apiextensions::V1beta1::JSONSchemaProps }, presence: false
    validates :any_ofs, array: { kind_of: KubeDSL::DSL::Apiextensions::V1beta1::JSONSchemaProps }, presence: false
    ...
    validates :enums, array: { kind_of: KubeDSL::DSL::Apiextensions::V1beta1::JSON }, presence: false
    ...
    validates :external_docs, object: { kind_of: KubeDSL::DSL::Apiextensions::V1beta1::ExternalDocumentation }
    ...
    validates :not_field, object: { kind_of: KubeDSL::DSL::Apiextensions::V1beta1::JSONSchemaProps }
    validates :nullable, field: { format: :boolean }, presence: false
    validates :one_ofs, array: { kind_of: KubeDSL::DSL::Apiextensions::V1beta1::JSONSchemaProps }, presence: false
