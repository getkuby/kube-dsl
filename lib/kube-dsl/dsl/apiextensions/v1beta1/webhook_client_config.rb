module KubeDSL::DSL::Apiextensions::V1beta1
  class WebhookClientConfig < ::KubeDSL::DSLObject
    ...
    object_field(:service) { KubeDSL::DSL::Apiextensions::V1beta1::ServiceReference.new }
    value_field :url

    validates :ca_bundle, field: { format: :string }, presence: false
    validates :service, object: { kind_of: KubeDSL::DSL::Apiextensions::V1beta1::ServiceReference }
