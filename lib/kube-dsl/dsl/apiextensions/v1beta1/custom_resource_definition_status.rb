...
module KubeDSL::DSL::Apiextensions::V1beta1
  class CustomResourceDefinitionStatus < ::KubeDSL::DSLObject
    ...
    validates :accepted_names, object: { kind_of: KubeDSL::DSL::Apiextensions::V1beta1::CustomResourceDefinitionNames }
    validates :conditions, array: { kind_of: KubeDSL::DSL::Apiextensions::V1beta1::CustomResourceDefinitionCondition }, presence: false
