...
module KubeDSL::DSL::Autoscaling::V2beta2
  class MetricSpec < ::KubeDSL::DSLObject
    object_field(:container_resource) { KubeDSL::DSL::Autoscaling::V2beta2::ContainerResourceMetricSource.new }
    ...
    validates :container_resource, object: { kind_of: KubeDSL::DSL::Autoscaling::V2beta2::ContainerResourceMetricSource }
