module KubeDSL::DSL::Policy
  class PodSecurityPolicySpec
    ...
    array_field(:allowed_csi_driver) { KubeDSL::DSL::Policy::AllowedCSIDriver.new }
    array_field :allowed_capability
    array_field(:allowed_flex_volume) { KubeDSL::DSL::Policy::AllowedFlexVolume.new }
    array_field(:allowed_host_path) { KubeDSL::DSL::Policy::AllowedHostPath.new }
    ...
    array_field(:host_port) { KubeDSL::DSL::Policy::HostPortRange.new }
    array_field :required_drop_capability
    array_field :volume
    object_field(:fs_group) { KubeDSL::DSL::Policy::FSGroupStrategyOptions.new }
    object_field(:run_as_group) { KubeDSL::DSL::Policy::RunAsGroupStrategyOptions.new }
    object_field(:run_as_user) { KubeDSL::DSL::Policy::RunAsUserStrategyOptions.new }
    object_field(:runtime_class) { KubeDSL::DSL::Policy::RuntimeClassStrategyOptions.new }
    object_field(:se_linux) { KubeDSL::DSL::Policy::SELinuxStrategyOptions.new }
    object_field(:supplemental_groups) { KubeDSL::DSL::Policy::SupplementalGroupsStrategyOptions.new }
