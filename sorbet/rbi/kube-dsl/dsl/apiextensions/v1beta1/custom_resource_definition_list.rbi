  ...
  class CustomResourceDefinitionList < ::KubeDSL::DSLObject
    ...
    sig {
      params(
        ...
        block: T.nilable(T.proc.returns(KubeDSL::DSL::Apiextensions::V1beta1::CustomResourceDefinition))
      ).returns(T::Array[KubeDSL::DSL::Apiextensions::V1beta1::CustomResourceDefinition])
    }
