  ...
  class PodSecurityPolicySpec < ::KubeDSL::DSLObject
    ...
    sig {
      params(
        ...
        block: T.nilable(T.proc.returns(KubeDSL::DSL::Extensions::V1beta1::AllowedCSIDriver))
      ).returns(T::Array[KubeDSL::DSL::Extensions::V1beta1::AllowedCSIDriver])
    }
    ...
    sig {
      params(
        elem_name: T.nilable(Symbol),
        block: T.nilable(T.proc.returns(KubeDSL::DSL::Extensions::V1beta1::AllowedFlexVolume))
      ).returns(T::Array[KubeDSL::DSL::Extensions::V1beta1::AllowedFlexVolume])
    }
    ...
    sig {
      params(
        elem_name: T.nilable(Symbol),
        block: T.nilable(T.proc.returns(KubeDSL::DSL::Extensions::V1beta1::AllowedHostPath))
      ).returns(T::Array[KubeDSL::DSL::Extensions::V1beta1::AllowedHostPath])
    }
    ...
    sig {
      params(
        elem_name: T.nilable(Symbol),
        block: T.nilable(T.proc.returns(KubeDSL::DSL::Extensions::V1beta1::HostPortRange))
      ).returns(T::Array[KubeDSL::DSL::Extensions::V1beta1::HostPortRange])
    }
