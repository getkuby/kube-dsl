  ...
  class FlowSchemaSpec < ::KubeDSL::DSLObject
    ...
    sig {
      params(
        ...
        block: T.nilable(T.proc.returns(KubeDSL::DSL::Flowcontrol::V1alpha1::PolicyRulesWithSubjects))
      ).returns(T::Array[KubeDSL::DSL::Flowcontrol::V1alpha1::PolicyRulesWithSubjects])
    }
